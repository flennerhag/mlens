...
if has_nosetests.returncode:
    ...
    if installation.returncode:
        ...
        print("Installation failed. Aborting test. Ensure a valid version of "
              "nosetests is installed (i.e. pip install nose nose-exclude).")
        exit()
...
with open("check_build_log.txt", "wb") as f:
    ...
    for m in [header, python_version, os_version, mlens_version, build_start]:
        f.write(bytes(m + "\n\n", "utf-8"))
