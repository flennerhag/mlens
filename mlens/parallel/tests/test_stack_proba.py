...
def test_layer_predict():
    """[Parallel | Stack | Prep | Proba] test layer predict."""
    layer_predict(layer, cache, P, wp)


def test_layer_transform():
    """[Parallel | Stack | Prep | Proba] test layer transform."""
...
def test_lc_csv():
    """[Parallel | Stack | Prep | Proba] test layer container from csv."""
    lc_from_csv(lc, cache, X, y, F, wf, P, wp)


def test_lc_prop():
    """[Parallel | Stack | Prep | Proba] test layer container feature propagation."""
